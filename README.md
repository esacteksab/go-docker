...
- **Go Version:** Configurable via repository variables `GO_VERSION=1.25.5`
...
- `1.25.5` (or current Go version) - Tagged with the specific Go version
- `1.25.5-YYYY-MM-DD` - Version with build date for historical reference
